  ...
  return (
    <div className=" mx-8 flex-wrap flex   mt-3">
      <div className="w-2/6  border-2 my-2 bg-white py-4">
        <h2 className="ml-6 my-2 font-medium ">General Information</h2>
      ...
      <div className="w-2/6 my-2   py-4 bg-white border-2">
        <h2 className="ml-9 my-2 font-medium">Live Statistics</h2>
        <div className="flex justify-evenly">
          <div className="w-20 flex flex-col relative">
            ...
            <p className="absolute ml-7 mt-7 text-xl text-gray-400">15</p>
          </div>
          <div className="w-20 flex flex-col relative">
            <Second />
            <p className=" text-sm text-center border-blue-400 border-2 mt-3 text-blue-400">
            ...
            <p className="absolute ml-7 mt-7 text-xl text-gray-400">27</p>
          </div>
          <div className="w-20 flex flex-col relative">
            <Third />
            <p className=" text-sm text-center border-blue-400 border-2 mt-3 text-blue-400">
            ...
            <p className="absolute ml-8 mt-7 text-xl text-gray-400">1</p>
          </div>
        </div>
      </div>{" "}
      <div className="border-2 w-2/6 flex my-2 bg-white  justify-end">
        <div className=" ">
          <h2 className="ml-6 my-2 font-medium">Location-Devices</h2>
          <img
